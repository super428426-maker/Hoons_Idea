...
const NaverMapLogo = () => (
  <svg width="60" height="20" viewBox="0 0 60 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#03C75A]">
    <svg x="0" y="2" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      <path d="M16.273 12.845 7.376 0H0v24h7.726V11.156L16.624 24H24V0h-7.727v12.845Z" />
    </svg>
    <text x="22" y="14" className="font-sans text-[10px] font-bold fill-current">Map</text>
  </svg>
);

const KakaoMapLogo = () => (
  <svg width="64" height="20" viewBox="0 0 64 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#FEE500]">
    <svg x="0" y="2" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
...
const GoogleMapLogo = () => (
  <svg width="66" height="20" viewBox="0 0 66 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#4285F4]">
    <svg x="0" y="2" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
    ...
    <text x="19" y="14" className="font-sans text-[10px] font-bold fill-current">Maps</text>
  </svg>
);
